...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-foreground/[0.04] p-1 text-muted-foreground border border-foreground/10 backdrop-blur-sm",
      className
    )}
    {...props}
  />
